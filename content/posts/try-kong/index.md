...
curl -i -X POST --url http://10.0.0.11:8001/apis  --data 'name=admin-api' --data 'hosts=a.k.wutuofu.com' --data 'upstream_url=http://localhost:8080'
...
```nginx
 valid_referers *.wutuofu.cn wutuofu.cn  *.wutuofu.com wutuofu.com;
