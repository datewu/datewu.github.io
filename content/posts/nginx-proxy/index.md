...
### demo2-https
    ...
    server {
        ...
        ssl_certificate /var/lib/teleport/wutuofu.com/cert.pem;
        ssl_certificate_key /var/lib/teleport/wutuofu.com/key.pem;
