...
```bash
[root@wutuofu ~]# cat /proc/1/cgroup
11:perf_event:/
10:memory:/
9:devices:/
8:cpuacct,cpu:/
...
2:pids:/
1:name=systemd:/
[root@wutuofu ~]# cat /proc/19/cgroup
11:perf_event:/
10:memory:/
9:devices:/
8:cpuacct,cpu:/
...
```bash
[root@wutuofu ~]# cat /proc/20397/cgroup
...
```bash
[root@wutuofu ~]# docker run --name mysql  -p 3306:3306  -e MYSQL_ROOT_PASSWORD=super123456secret -d mysql:5.7.28
...
[root@wutuofu ~]# ps aux | grep mysql
...
[root@wutuofu ~]# cat /proc/23855/cgroup
...
[root@wutuofu ~]# docker ps | grep 771aa2fdc
...
```bash
[root@wutuofu ~]# kubectl exec -it binary-controller-7dfd4bbd6f-6hsvd sh
/ # ps
