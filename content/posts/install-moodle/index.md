...
### 初始化主机
```shell
hostnamectl set-hostname wutuofu.com
...
server {
    server_name  moodle-demo.wutuofu.com;

    ssl  on;
    listen [::]:443 ssl ipv6only=on; # managed by Certbot
    listen 443 ssl; # managed by Certbot
    ssl_certificate /etc/letsencrypt/live/moodle-demo.wutuofu.com/fullchain.pem; # managed by Certbot
    ssl_certificate_key /etc/letsencrypt/live/moodle-demo.wutuofu.com/privkey.pem; # managed by Certbot
...
# http -> https
server {
    if ($host = moodle-demo.wutuofu.com) {
